...
**2. Actor chính:** Host (Chủ Nhà), Admin (Quản trị viên)
**3. Mục tiêu:**
...
**9.1. Ngoại lệ Đăng nhập:**
  ...
  - **A3. Tài khoản đang chờ duyệt:** (Tại bước 7) Nếu tài khoản có `status` là **`pending`**, chặn đăng nhập và báo: "Tài khoản của bạn đang chờ phê duyệt từ Quản trị viên."
...
**10. Quy tắc nghiệp vụ (Business Rules):**
  - Mật khẩu bắt buộc mã hóa bằng thuật toán băm chiều (e.g., Bcrypt/Argon2). Hệ thống tuyệt đối không lưu dạng plain-text.
