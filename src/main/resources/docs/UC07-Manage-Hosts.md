...
**4. Mô tả ngắn:** Guest không tự tạo được Host. Admin sẽ Thêm account thủ công. Admin cũng quản lý bảng Data chứa tất cả mọi người dùng nền tảng để Ban nick nếu phát hiện gian lận.
**5. Tiền điều kiện:** 
...
**8. Luồng chính (Main Flow - Cấp Account Mới):**
  ...
  3. Admin điền thông tin đối tác Host: Tên đối tác (Họ tên), Số ĐT (dùng ghim lên mọi bài rao), Address Email, Gen ra 1 chuỗi ngẫu nhiên "Password". Roles set Cứng (Host).
  4. Submit Button.
  5. API kiểm tra Validation Email Unique / SDT Unique.
  6. DB Bảng `Users` Insert Data mã hóa mật khẩu.
  7. Email Service kích hoạt, bắn SendMail "Chào mừng bạn được tạo tài khoản thành viên hệ thống nền tảng X, đây là thông tin credential..." gửi thẳng tay Host.
